...
/// The "what Noticed is, isn't" sheet. Static copy; sets the ground rules
        ...
        ZStack {
            ...
            ScrollView(showsIndicators: false) {
                VStack(alignment: .leading, spacing: Theme.Spacing.l) {
                    ...
                    AboutSection(
                        title: "what it is",
                        text: "a quiet food–body record. log a meal in ten seconds. each night — or when you pull to refresh — Noticed looks over your last few weeks and surfaces a few hedged patterns from your own data, if there are any worth watching. before there's enough to go on, it just describes what's written down."
                    )
                    AboutSection(
                        title: "what it isn't",
