    ...
    var body: some View {
        ZStack {
            ...
            VStack(alignment: .leading, spacing: Theme.Spacing.l) {
                ...
                Text("Somatic reads steps, sleep, resting heart rate, HRV, weight, active energy and workouts to look for gentle correlations. Raw HealthKit samples stay on your phone — only a daily summary is stored.")
