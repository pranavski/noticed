        ...
        ZStack {
            ...
            ScrollView(showsIndicators: false) {
                VStack(alignment: .leading, spacing: Theme.Spacing.l) {
                    ...
                    Text("with this on, the text of a meal you log goes to Claude — an AI model made by Anthropic — to be parsed, and once a night a compact summary of your recent meals, check-ins and daily health totals goes over so Somatic can look for patterns. no name, no email, no account id, no raw health samples, no audio.")
    ...
    private var statusCard: some View {
        HStack(spacing: Theme.Spacing.m) {
            ...
            Text(disclosure.hasConsented
                 ? "Somatic sends meals to Claude to be read."
