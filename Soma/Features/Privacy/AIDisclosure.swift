        ...
        ZStack {
            ...
            ScrollView(showsIndicators: false) {
                VStack(alignment: .leading, spacing: Theme.Spacing.l) {
                    ...
                    Text("Somatic reads your meal with help from Claude.")
                    ...
                    Text("and once a night, if there's enough to go on, Somatic sends Claude a compact summary of your last few weeks — meals, energy check-ins, and the daily Apple Health numbers you've connected — to look for patterns worth mentioning. never the raw health samples; those stay on your phone.")
                        .font(Font.Soma.dishNote)
                        .foregroundStyle(Color.ink)
                        .lineSpacing(3)
                        .fixedSize(horizontal: false, vertical: true)
